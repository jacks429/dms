...
import { r as resolveSrc, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS, c as isRemotePath, d as isRemoteAllowed } from '../astro/assets-service_BKQNkkg4.mjs';
import { i as getDefaultExportFromCjs, A as AstroError, j as InvalidImageService, k as ExpectedImageOptions, E as ExpectedImage, l as FailedToFetchRemoteImageDimensions, c as createAstro, b as createComponent, n as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, f as addAttribute, s as spreadAttributes } from '../astro_DinsJ35h.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_BKQNkkg4.mjs'
    ).then(n => n.n).catch((e) => {
